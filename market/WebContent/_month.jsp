<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8" import="java.sql.*, java.sql.Date, market.*, java.util.*, java.text.ParseException, java.text.SimpleDateFormat"%>
...
<body>
	...
	if (Integer.parseInt(month)==12)
		date2 = Integer.toString((Integer.parseInt(year)+1))+"-"+Integer.toString(((Integer.parseInt(month)+1)%12))+"-"+"01";
	System.out.println(date2);
	Date d1 = Date.valueOf(date);
	Date d2 = Date.valueOf(date2);
	
	query = "SELECT SUM(L.Pquantity * I.Price) as summ "+
