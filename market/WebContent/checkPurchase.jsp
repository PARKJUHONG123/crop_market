<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8" import="market.*,java.sql.*,java.util.*,java.sql.Date"%>

   <% request.setCharacterEncoding("UTF-8"); %>
<%
final class MemberBean{
	private Date date;
	private int orderNum;
	private String pitem;
	private int pquantity;
	
	public MemberBean(){this.date = null; this.orderNum=0; this.pitem=null; this.pquantity=0;}
